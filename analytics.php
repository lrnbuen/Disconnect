...
<main>
    ...
    <div class="stats-row">
        ...
        <div class="stat-card">
            ...
            <span class="stat-lbl">avg mood (avoided)</span>
        </div>
        <div class="stat-card">
            <span class="stat-num"><?= $avgMoodUsed ?></span>
            <span class="stat-lbl">avg mood (used)</span>
        </div>
        <div class="stat-card">
    ...
    <!-- charts side by side: mood on left, success on right -->
    <div class="analytics-row">

        <div class="card">
            <h2 class="card-title">mood over time</h2>
            <?php if (empty($moodDates)): ?>
                <p class="empty-msg">no mood data yet — log your mood to see this chart.</p>
            <?php else: ?>
        ...
        <div class="card">
            ...
            <?php if (empty($weekLabels)): ?>
                <p class="empty-msg">no tracking data yet — start logging to see this chart.</p>
            <?php else: ?>
