...
while ($row = $streakQuery->fetch_assoc()) {
    ...
    if ($row['avoided'] == 0)   $logsByDate[$d] = 0; // one failure marks the whole day
}
...
<main class="two-col">
    ...
    <div class="col-left">
        ...
        <!-- heatmap — one square per day for the last 12 weeks -->
        <div class="card">
        ...
        <div class="card">
            ...
            <form method="POST" action="track.php">
                ...
                <div class="field" id="customField" style="display:none;">
                    ...
                    <input type="text" name="custom_platform" id="customPlatform" placeholder="e.g. Netflix, news sites...">
                </div>

                <!-- two submit buttons — each sends a different avoided value -->
                <div class="btn-row">
                    <button type="submit" name="avoided" value="1" class="btn btn-success">✓ avoided it</button>
                    <button type="submit" name="avoided" value="0" class="btn btn-muted">✗ used it</button>
                </div>
...
<!-- show/hide the custom input when "other" is picked -->
<script>
